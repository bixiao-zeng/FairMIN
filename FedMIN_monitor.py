...
parser.add_argument('--skip_warmup', default=False)
...
parser.add_argument('--load_SL', default=False, type=bool)
        ...
        for epoch in range(args.start_epoch, args.num_epochs + 1):
            ...
            if epoch==args.start_epoch:
                if not args.autoload:
                    ...
                    with open(os.path.join(serverPath,'rho.pkl'),'wb') as f:
                        pickle.dump(rho,f)
